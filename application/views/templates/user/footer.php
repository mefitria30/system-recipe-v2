        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="footer-item">
                    ...
                    <div class="row g-2">
                        <div class="col-4">
                            <img src="<?= base_url('assets/user/')?>img/menu-01.jpg"
                                class="img-fluid rounded-circle border border-primary p-2" alt="">
                        </div>
                        <div class="col-4">
                            <img src="<?= base_url('assets/user/')?>img/menu-02.jpg"
                                class="img-fluid rounded-circle border border-primary p-2" alt="">
                        </div>
                        <div class="col-4">
                            <img src="<?= base_url('assets/user/')?>img/menu-03.jpg"
                                class="img-fluid rounded-circle border border-primary p-2" alt="">
                        </div>
                        <div class="col-4">
                            <img src="<?= base_url('assets/user/')?>img/menu-04.jpg"
                                class="img-fluid rounded-circle border border-primary p-2" alt="">
                        </div>
                        <div class="col-4">
                            <img src="<?= base_url('assets/user/')?>img/menu-05.jpg"
                                class="img-fluid rounded-circle border border-primary p-2" alt="">
                        </div>
                        <div class="col-4">
                            <img src="<?= base_url('assets/user/')?>img/menu-06.jpg"
                                class="img-fluid rounded-circle border border-primary p-2" alt="">
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                <span class="text-light"><a href="#"><i class="fas fa-copyright text-light me-2">
                            Copyright &copy; RecipesKitchen <?= date('Y');?>
                </span>
            </div>
        </div>
    </div>
